---
name: nebularag
description: NebulaRAG repository skill for RAG-first retrieval and project memory using the unified MCP tools.
...
5. Before ending non-trivial sessions, store concise project learnings with `memory` (`action: "store"`).
