...
public sealed class RagIndexer
{
    ...
    public async Task<IndexSummary> IndexDirectoryAsync(string sourceDirectory, string? projectId = null, CancellationToken cancellationToken = default)
    {
    ...
    /// </summary>
    private static string BuildSourceStoragePath(string projectRootPath, string sourceRootPath, string filePath, string? projectId)
    {
        ...
        return SourcePathNormalizer.ApplyExplicitProjectPrefix(normalizedSourcePath, projectId);
    }
